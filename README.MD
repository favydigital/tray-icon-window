...
```
npm install @favyteam/tray-icon-window
```
...
```js
const trayWindow = require("tray-icon-window");
```
...
| setTrayIcon   | Set Tray Icon Dynamically                                         |
| getTray       | Object type. get Tray Object                                      |
